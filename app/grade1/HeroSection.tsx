        ...
        <div style={{
          ...
          <motion.div variants={container} initial="hidden" animate="show">
            ...
            <motion.h1 variants={fadeUp} style={{
              ...
              <span style={{ display: 'block', color: '#fff' }}>أولى ثانوي</span>
              <span style={{
                display: 'block',
            ...
            <motion.p variants={fadeUp} style={{
              ...
              ابدأ صح من أولى ثانوي… وافهم التكنولوجيا مش بس تستخدمها!
            </motion.p>
            ...
            <motion.p variants={fadeUp} style={{
              ...
              مش مجرد مادة دراسية — دي بدايتك الحقيقية لفهم برمجة الكمبيوتر، الخوارزميات، والذكاء الاصطناعي بطريقة سهلة وعملية تجهزك للسنين الجاية وتضمنلك التفوق.
            </motion.p>

            {/* Action Buttons */}
            <motion.div variants={fadeUp} style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginBottom: 40 }}>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                <Link href="/grade1/start" className="btn btn-lg" style={{
